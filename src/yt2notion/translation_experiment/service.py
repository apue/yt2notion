...
class TranslationExperimentRunner:
    ...
    def run(
        ...
        return TranslationExperimentResult(
            ...
            blind_review_path=artifacts.blind_review_path,
            answer_key_path=artifacts.answer_key_path,
            manifest_path=artifacts.manifest_path,
            evaluation_path=artifacts.evaluation_path,
            objective_gates_passed=artifacts.objective_gates_passed,
            timings_seconds=timings,
        )
